...
\begin{itemize}
\item Severidad (0): teniendo el \textit{backup} no representa ninguna severidad que el dataset deje de estar disponible en línea.
...
\end{itemize}
\item Riesgo 3: si fuera necesario y dentro de lo disponible, extender el dataset con imágenes e informácion disponible en internet.
\begin{itemize}
